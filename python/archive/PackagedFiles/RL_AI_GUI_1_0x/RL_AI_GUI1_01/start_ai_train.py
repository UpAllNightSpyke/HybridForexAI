...
def main(symbol='XAUUSD', timeframe=mt5.TIMEFRAME_H1, start_date=datetime(2022, 1, 1), end_date=datetime(2022, 12, 31), account=0, password='AItester1!', server='PlexyTrade-Server01', mt5_path=''):
    ...
    scrape_mt5_data(symbol, timeframe, start_date, end_date, raw_output_file, account, password, server, mt5_path)
