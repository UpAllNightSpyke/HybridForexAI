...
class IndicatorSettingsWindow:
    ...
    def open_indicator_settings(self, indicator):
        ...
        if indicator.lower() == 'rsi':
            ttk.Label(settings_window, text='overbought').grid(row=len(params), column=0, padx=10, pady=5, sticky=tk.W)
            ...
            ttk.Entry(settings_window, textvariable=overbought_var).grid(row=len(params), column=1, padx=10, pady=5, sticky=tk.EW)

            ttk.Label(settings_window, text='oversold').grid(row=len(params) + 1, column=0, padx=10, pady=5, sticky=tk.W)
            ...
            ttk.Entry(settings_window, textvariable=oversold_var).grid(row=len(params) + 1, column=1, padx=10, pady=5, sticky=tk.EW)
