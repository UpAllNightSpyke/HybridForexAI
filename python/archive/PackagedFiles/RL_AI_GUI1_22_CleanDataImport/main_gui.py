...
from indicators.functions import indicator_functions, initialize_indicators, get_available_indicators  # Add get_available_indicators import
...
class ForexApp:
    ...
    def add_footer(self):
        ...
        ttk.Label(self.root, text="Version 1.22a").grid(column=2, row=2, padx=10, pady=5, sticky='e')
