...
void OnStart()
{
    ...
    int file_handle = FileOpen("MarketData.tsv", FILE_WRITE|FILE_CSV|FILE_COMMON, "\t");  // Open the TSV file for writing
    if(file_handle != INVALID_HANDLE)
    {
        ...
        Print("Data written to MarketData.tsv");  // Print a success message
    }
    else
    {
